...
s_or_d_list
    : s_or_d                            { $$ = new_node(NODE_LIST); add_to_ast_list($$, $1); }
    | s_or_d_list s_or_d                { $$ = $1; add_to_ast_list($$, $2); }
...
function_definition
    ...
    | declarator compound_statement
        { $$ = combine_binary(new_token(TOK_KW_INT), new_node(NODE_FUNCTION), $1); add_to_ast_list($$, $2); }
    ;
